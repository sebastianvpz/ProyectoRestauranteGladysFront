...
export function DishCard({ dish, variant = "public", className, action }: DishCardProps) {
  ...
  return (
    <article className="group bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
      <div className="aspect-[4/3] bg-gradient-to-br from-[#C75D3A]/20 to-[#D4A853]/20 flex items-center justify-center relative">
        <div className="absolute top-4 right-4 bg-[#C75D3A] text-white px-3 py-1 rounded-full text-sm font-semibold">
